...
### Samkvæmt myndritunu í lið n getum við séð að póstnúmerið í 105 er með dýrustu eignirnar en sjáum ekki endilega fjölda á eignum en getum ályktað að það er mögulega hæsta fermetraverðið miðað við hin tvö og 112 myndi þá vera með minnsta verðið.
```{r}
# Finna gögn
...
### Sjáum að 107 er með dýrasta fermetraverðið þannig tilgátan stóðst ekki alveg en 112 er samt sem áður með minnsta þannig það stóðst.
